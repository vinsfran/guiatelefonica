...
@RequestMapping("/lugartelefono")
public class LugarTelefonoController {

    public static final Log LOG = LogFactory.getLog(LugarTelefonoController.class);
    ...
    public String cancel() {
        return "redirect:/" + ViewConstant.LUGAR_TELEFONO_LIST;
    }
    ...
    public String redirectLugarForm(@RequestParam(name = "id", required = false) int id,
        ...
        return ViewConstant.LUGAR_TELEFONO_FORM;
    }
    ...
    public ModelAndView addLugar(@ModelAttribute(name = "lugarModel") LugarModel lugarModel) {
        ...
        ModelAndView mav = new ModelAndView(ViewConstant.LUGAR_TELEFONO_LIST);
        if (lugarService.addLugar(lugarModel) != null) {
            LOG.info("METHOD: addLugar() -- result: " + 1);
            mav.addObject("result", 1);
            return showLugarTelefonos("Agregado Correctamente!", "alert alert-success");
        } else {
            LOG.info("METHOD: addLugar() -- result: " + 0);
            mav.addObject("result", 0);
            return showLugarTelefonos("Error agregando Tipo de Lugar!", "alert alert-danger");
        }
...
//        return mav;
    ...
    @GetMapping({"/", "/list"})
    public ModelAndView showLugarTelefonos(@RequestParam(name = "mensaje", required = false) String mensaje,
    ...
    public ModelAndView removeLugar(@RequestParam(name = "id", required = true) int id) {
        ...
        return showLugarTelefonos("Tipo de Lugar eliminado!", "alert alert-info");
    }
}
